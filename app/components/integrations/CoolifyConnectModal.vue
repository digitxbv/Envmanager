<template>
  <Dialog
    ...
    description="Connect your self-hosted Coolify instance"
    @close="$emit('close')"
  >
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <p class="text-xs text-muted-foreground">
          The URL of your Coolify instance (no trailing slash)
        </p>
      </div>
      ...
      <div class="space-y-2">
        ...
        <p class="text-xs text-muted-foreground">
          Create a token at Security &gt; API Tokens in your Coolify dashboard.
        </p>
      </div>
...
import { useCoolifyIntegration, type CoolifyValidationResult } from '~/composables/useCoolifyIntegration'
...
const { validateToken, connect, validating, loading } = useCoolifyIntegration()
